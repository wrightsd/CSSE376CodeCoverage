...
{	
	...
	public void TestgetDiscount(){
		Discount targetD=new Discount(-0.5,1);
		ServiceLocator.Instance().AddDiscount(targetD);
		
		this.target.book(new Booking[]{new Flight(StartDate, EndDate, 100), new Hotel(5), new Car(3)});
		
		Discount targetSecond=new Discount(0.01,10000000);
		ServiceLocator.Instance().AddDiscount(targetSecond);
